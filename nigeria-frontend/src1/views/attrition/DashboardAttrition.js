...
const [isActive, setActive] = useState(false);
  ...
  const [sdate, setSData] = useState([]);
  const [today1, setTodayData] = useState([]);
  const [tdate, setTdate] = useState([]);
  const [tdate2, setTdate2] = useState([]);
...
let currentMonth = parseInt(formattedMonth);
...
const previousMon = `${formattedPreviousMonth}-${previousYear}`;
...
const handleSubmit = (event) => {
        ...
        //alert(jsonData);
        $.ajax({
           url: `${config.apiUrl}/getattritiondate`,
            method: "POST",
            ...
            success: function (response) {
                ...
                // Access all dates from the response object
                const { sdate, today, tdate, tdate2 } = response;
          ...
          <Col md="12">
            <Card className="card-user">
              ...
              <form onSubmit={handleSubmit} method='POST'>
                            <div className="row space justify-content-center mb-4">
                                ...
                                <span class="textred">* Please note that the date range is valid from 15-05-2024 onwards. You cannot filter dates before this day.</span><br/>
                            </div>

              </form>
             <div style={{ textAlign: 'center' }}>
            <span>Attendance Showing: </span>
            <span class="textgreen">Date: {tdate} </span>for <span class="textblue">OTA</span> 
            <span> and </span>
            <span class="textgreen">Date: {tdate2}</span> for  <span class="textblue">IKEJA</span>
            ...
            <table width="100%" border="1" cellspacing="0" className="border-class">
             ...
             <tr>
              ...
              <div className="mt-4 row">
                <div class="col-md-6">
                 <div style={{ textAlign: 'center' }}>
                  <span>Attendance Showing for both </span><span class="textblue">OTA</span> 
                  <span> and </span><span class="textblue">IKEJA</span>&nbsp; Date:
                  <span class="textgreen"> {date1}</span> 
                  </div>
...
<>
              ...
              <div className="mt-4 mb-4 row">
                <div className="col-4">
                  <table width="100%" border="1" cellspacing="0" className="border-class">
                    <tr>
                      <td colspan="2" style={{ textAlign: 'center' }}><strong>ATTRITION - MTD</strong> (Previous month: {previousMon})</td>
                    </tr>
                    <tr>
                      <th>CATEGORY</th>
                      <th>TOTAL</th>
