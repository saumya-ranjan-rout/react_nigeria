...
export function AddAssignNbraid() {
 ...
 useEffect(() => {
    if (OpUserName && OpUserName.entryid) {
      $.ajax({
        url: `${config.apiUrl}/ota/getuserid/${OpUserName.entryid}`,
        method: 'GET',
        headers: customHeaders,
        success: function (response) {
          setUserid(response);
  ...
  useEffect(() => {
    if (userId && userId.id) {
      $.ajax({
        url: `${config.apiUrl}/ota/getSectionitem/${userId.id}`,
        method: 'GET',
        headers: customHeaders,
        success: function (response) {
          setItems(response);
...
const handleSubmit = (event) => {
  ...
  $.ajax({
    url: `${config.apiUrl}/ota/addSectionOp`,
    method: 'POST',
    headers: customHeaders,
    data: jsonData,
    processData: false,
  ...
  const handleDelete = (id) => {
    ...
    if (confirmDelete) {
      $.ajax({
        url: `${config.apiUrl}/ota/delete_section_assign/${id}`,
        method: 'DELETE',
        headers: customHeaders,
        success: function (response) {
          alert(response);
...
const handleSearchChange = (event) => {
  ...
  const handleMove = () => {
    ...
    const id=userId.id;
    const redirectURL = `/admin/hrm/ota/multiplesectionassignota/${id}/${ids}`;
...
export default AddAssignNbraid;
