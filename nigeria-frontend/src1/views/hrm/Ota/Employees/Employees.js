...
export function Employees() {
 ...
 const [modal, setModal] = useState(false); // Modal state
  ...
  const handleView = (id) => {
    navigate(`/admin/hrm/ota/viewworkerbraidota/${id}`);
  };
...
const [formData, setFormData] = useState({
  ...
  const encodedWhere = encodeURIComponent(where);
    ...
    $.ajax({
        url: `${config.apiUrl}/ota/get_employees?where=${encodedWhere}`,
        method: 'GET',
...
//////////////////////////////////////
  useEffect(() => {
    ...
    const fetchData = () => {
      $.ajax({
        url: `${config.apiUrl}/ota/get_employeess`,
        method: 'GET',
        headers: customHeaders,
        success: function (response) {
          // Set the fetched data in the state
    ...
    fetchData();
     ...
     const fetchDate = () => {
      $.ajax({
          url: `${config.apiUrl}/ota/get_employeess_date`,
          method: 'GET',
          headers: customHeaders,
          success: function (response) {
          // Set the fetched data in the state
