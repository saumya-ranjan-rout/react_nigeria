...
const [formErrors, setFormErrors] = useState({
  ...
  $.ajax({
    url: `${config.apiUrl}/ota/update_employee`,
    method: 'POST',
    headers: customHeaders,
    data: jsonData,
    processData: false,
    ...
    success: function (response){
         alert(response.message);
          navigate('/hrm/ota/employeelistota');
        },
    error: function (xhr, status, error){
      console.log(error);
    },
             ...
             <div className='row'>
                <div className='col-md-12'>
                    ...
                    <div className=" row space">
                        ...
                        <span className="Password">User Role</span> <span className='textred'>*</span>
                   ...
                   <div className="col-sm-6">
                        ...
                        <div className="col-sm-6">
                          <span className="section">Section Name </span> <span className='textred'>*</span>
                    ...
                    <div className=" row space">
                        <div className="col-sm-6">
                        <span className="Password">Worker Type</span> <span className='textred'>*</span>
                        ...
                        <div className="col-sm-6">
                        <span className="Password">Shift</span> <span className='textred'>*</span>
                      ...
                      <div className='row space'>
                        <div className="col-sm-3">
                              <span className="Password">Change Zone</span> <span className='textred'>*</span>
                        ...
                        <div className='col-sm-3'>
                          <span className="Password">Choose Machine</span> <span className='textred'>*</span>
                        ...
                        <div className='col-sm-6'>
                          <span className="Password">Change Machine</span> <span className='textred'>*</span>
