...
function EmployeeTimesheetBraidListIkejaOperator() {
...
const handleHourChange = (rowId, hourColumn, newValue) => {
  ...
  $.ajax({
    url: 'http://192.168.29.60:4000/updateHourValue', // Replace with the appropriate API endpoint
...
const handleView = (id) => {
   ...
   const handleSubmit = (event) => {
    ...
    $.ajax({
      url: 'http://192.168.29.60:4000/getemployeetimesheetdata',
      method: "POST",
      data: jsonData,
        processData: false,
      contentType: 'application/json',
...
useEffect(() => {
      ...
      $.ajax({
      url: `http://192.168.29.60:4000/getdefaultemployeetimesheetdatabraidoplogin/${userid}`,
      method: 'GET',
      processData: false,
      contentType: 'application/json',
      success: function (response) {
      ...
      const fetchProductOptions = () => {
        $.ajax({
          url: 'http://192.168.29.60:4000/getProductOptions',
          method: 'GET',
          success: function (response) {
...
window.handleView = handleView;
  ...
  const handleProductChange = (e) => {
      ...
      $.ajax({
        url: `http://192.168.29.60:4000/getLineOptions/${selectedProduct}`,
        method: 'GET',
        success: function (response) {
  ...
  const handleDelete = (id) => {
    ...
    if (confirmDelete) {
      fetch('http://192.168.29.60:4000/emptimesheet_delete', {
        method: 'POST',
        headers: {
      ...
      //axios.post('http://192.168.29.60:4000/emptimesheet_delete', { deleteid: id })
        .then((response) => {
