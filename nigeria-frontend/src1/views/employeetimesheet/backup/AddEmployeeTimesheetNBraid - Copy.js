...
const handleSubmit = (event) => {
  ...
  $.ajax({
    url: 'http://192.168.29.60:4000/getaddemployeetimesheetfilterdatanbraidota',
    method: 'POST',
    data: jsonData,
    processData: false,
...
const handleSubmitnew = (event) => {
  ...
  $.ajax({
    url: 'http://192.168.29.60:4000/insertemployeetimesheetnbraidotadata',
    type: 'POST',
...
// Destroy the existing DataTable instance (if it exists)
  ...
  tableRef.current = $('#example').DataTable({
    ...
    // Fetch line options from API
      ...
      $.ajax({
        url: `http://192.168.29.60:4000/getindividualLineOptions/${roleId}/${userid}`,
        method: 'GET',
        success: function (response) {
...
const handleProductChange = (selectedOption) => {
  if (selectedOption && selectedOption.value) {
    ...
    $.ajax({
      url: `http://192.168.29.60:4000/getcolordescription/${selectedProduct}`,
      method: 'GET',
      success: function (colorResponse) {
        ...
        $.ajax({
          url: `http://192.168.29.60:4000/gettargetnbraid/${selectedProduct}?section=${selectedSection}`, // Replace with your endpoint URL
          method: 'GET',
          success: function (response) {
