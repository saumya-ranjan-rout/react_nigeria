...
const handleSubmit = (event) => {
 ...
 console.log('Request Payload:', jsonData);
  $.ajax({
    url: `http://192.168.29.60:4000/getaddemployeetimesheetfilterdatanbraidotaoplogin/${userid}`,
    method: 'POST',
    data: jsonData,
    processData: false,
...
const handleSubmitnew = (event) => {
  ...
  $.ajax({
    url: `http://192.168.29.60:4000/insertemployeetimesheetnbraidotadataoplogin/${userid}`,
    type: 'POST',
...
useEffect(() => {
    ...
    const fetchSectionOptions = () => {
      $.ajax({
        url: `http://192.168.29.60:4000/getSectionOptionsOpLogin/${userid}`,
        method: 'GET',
        success: function (response) {
