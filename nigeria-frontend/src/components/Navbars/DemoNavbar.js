...
function Header(props) {
  ...
  if (window.innerWidth >= 768) {
    ...
    brandContent = (
      <>
              <a href="#" className="btn btn-primary mr-2" style={{ margin: '0', padding: '4px', fontSize: '12px' }} onClick={getAttendance}>
  <i className="fa fa-calendar" aria-hidden="true"></i> Get Attendance
</a>
      </>
    );
  } else {
  ...
  return (
    ...
    >
      <Container fluid>
        ...
        <a onClick={() => { navigate('/admin/languagechange'); }} className="btn btn-danger mr-2">Languages</a>
          <Nav navbar>
           {/* {roleId == 5 && (
          <Dropdown
              nav
        ...
        alt="Profile" style={{ width: '50px',borderRadius: '70px' }}/>*/}
            ...
            >
              ...
              <DropdownMenu right>
              <DropdownItem tag={Link} to="/admin/master/companysetting">Company Setting</DropdownItem>
              <DropdownItem tag={Link} to={`/admin/changepassword/${userdetails.entryid}`}> Change Password </DropdownItem>
              {roleId == 5 && (
