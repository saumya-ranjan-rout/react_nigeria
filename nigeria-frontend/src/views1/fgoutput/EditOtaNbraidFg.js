...
const handleSubmit = (event) => {
    ...
    $.ajax({
       url: `${config.apiUrl}/fg_output_update_ota_nbraid`,
      method: 'POST',
...
useEffect(() => {
    ...
    if (!isLoggedIn) {
      ...
      $.ajax({
         url: `${config.apiUrl}/getfgoutputDataOtanbraid/${id}`, // Replace with your API endpoint URL
        method: 'GET',
        headers: customHeaders,
        success: function (response) {
...
// Fetch shift options from API
    ...
    $.ajax({
      url: `${config.apiUrl}/getColorOptionsedit/${productCode}`,
      method: 'GET',
      headers: customHeaders,
      success: function (response) {
...
export default EditOtaNbraidFg;
