...
const [isActive, setActive] = useState(false);
 ...
 useEffect(() => {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: `${config.apiUrl}/addworkertype`,
      method: "POST",
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              <CardHeader>
                <CardTitle tag="h5">Add New Workertype</CardTitle>
                <hr></hr>
              </CardHeader>
              <CardBody>
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-sm-6">
                        <input
                          ...
                          name="workertype_name"
                          value={formData.workertype_name}  onChange={handleInputChange} required
                        />
...
export default AddNewWorkerType;
