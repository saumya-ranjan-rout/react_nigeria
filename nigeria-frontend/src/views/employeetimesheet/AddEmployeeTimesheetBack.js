...
function AddEmployeeTimesheetBack() {
 ...
 const [sectionOptions, setSectionOptions] = useState([]);
  ...
  const customHeaders = {
    ...
    const handleInputChange = (event) => {
     ...
     // alert(JSON.stringify({ ...formData, [name]: value }));
    };
    ...
    const handleSubmit = (event) => {
     ...
     // alert(jsonData);
      ...
      $.ajax({
        url:`${config.apiUrl}/getaddemployeetimesheetbackfilterdata`,
        method: 'POST',
        ...
        success: function (response) {
          ...
          if (response && response.length > 0) {
            ...
            alert('Response is empty or undefined');
            SetTargetAlert(false);
            setSaveDisable(true);
        ...
        error: function (xhr, status, error) {
          alert('Response is empty or undefined1q2q2qw2');
...
//  alert(JSON.stringify(dataToSend));
  $.ajax({
    url:`${config.apiUrl}/insertemployeetimesheetbackfilterdata`,
    type: 'PUT',
    headers: customHeaders,
    ...
    success: function (response) {
      ...
      setServerMessage('Worker Timesheet Successfully Added.');
...
const hourOptions = [
  ...
  { id: 5, label: 'HOUR5', value: 'HOUR5' },
  { id: 8, label: 'HOUR8', value: 'HOUR8' },
  { id: 11, label: 'HOUR11', value: 'HOUR11' },
...
useEffect(() => {
       ...
       document.title = 'Backdate Employee Timesheet';
  ...
  tableRef.current = $('#example').DataTable({
    ...
    const fetchShiftOptions = () => {
     ...
     // alert(urlshift);
      ...
      //alert(JSON.stringify(customHeaders));
...
export default AddEmployeeTimesheetBack;
