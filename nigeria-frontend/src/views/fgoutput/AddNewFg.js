            ...
            <Card className="card-user">
              ...
              <form onSubmit={handleSubmit} method='POST' >
               ...
               <div className="col-sm-3">
                ...
                <div class="col-sm-3">
                  ...
                  <input type="text" className="form-control margin-bottom required" name="code" id="code"  placeholder='Color Code'  />
                </div>
             ...
             <div class="col-sm-3 ">
                     ...
                     <span className="textgreen">Fg Output <span className="textred">*</span></span>
                         <input  type="text" className="form-control margin-bottom  " name="fgoutput" placeholder="FG Output" value={formData.fgoutput} onChange={handleInputChange}  required/>
                   
                </div>
                <div className="col-sm-2">
                  <span className="textgreen">Country <span className="textred">*</span></span>
                  <Select
