...
function ConvertToCategory() {
  ...
  fetchshift();
   ...
   const fetchOperator = () => {
    $.ajax({
      url: `${config.apiUrl}/ikeja/getConvertdata/${id}`,
      method: 'GET',
      headers: customHeaders,
      success: function (response) {
 ...
 let typ;
  ...
  $.ajax({
    url: `${config.apiUrl}/ikeja/category_convert_op`,
    method: 'POST',
    headers: customHeaders,
    data: jsonData,
    processData: false,
          ...
          <form onSubmit={handleSubmit} method='POST' >
             ...
             <div className=" row space">
                ...
                <div className="col-sm-6">
                   ...
                   <select className="form-control"  name="workertype" value={formData.workertype} onChange={handleInputChange} required>
