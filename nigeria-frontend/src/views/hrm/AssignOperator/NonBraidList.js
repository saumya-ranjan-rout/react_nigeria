...
export function NonBraidAssignList() {
  ...
  useEffect(() => {
  document.title = 'Show Operator Assign Work';
  ...
  if (!isLoggedIn) {
    ...
    const fetchUsers = () => {
      $.ajax({
        url: `${config.apiUrl}/ikeja/get_operator_nbraid_assign_list`,
        method: 'GET',
    ...
    fetchUsers();
     ...
     // Fetch shift options from API
      ...
      const fetchOperatorOptions = () => {
        $.ajax({
          url: `${config.apiUrl}/getIkejaOperatorOptions`,
          method: 'GET',
          headers: customHeaders,
          success: function (response) {
...
const handleSubmit = (event) => {
    ...
    $.ajax({
      url: `${config.apiUrl}/ikeja/search_operator_assignlist`,
      method: "POST",
      headers: customHeaders,
      data: jsonData,
      processData: false,
