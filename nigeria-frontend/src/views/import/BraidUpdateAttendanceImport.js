...
function BraidUpdateAttendanceImport() {
...
const handleBackup = (event) => {
    ...
    $.ajax({
      url: `${config.apiUrl}/downloademployeebackupBraid`,
      method: 'GET',
  ...
  $.ajax({
      url: `${config.apiUrl}/updateattendancebraid`,
      method: 'POST',
      headers: customHeaders,
      data: formData,
      contentType: false,
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              ...
              <CardBody>
              Update Employee Attendance For Ikeja
              <hr class="mb-2"></hr>
...
export default BraidUpdateAttendanceImport;
