...
function NonBraidUpdateAttendanceImport() {
...
const handleBackup = (event) => {
    ...
    $.ajax({
     url: `${config.apiUrl}/downloademployeebackupNbraid`,
      method: 'GET',
  ...
  $.ajax({
      url: `${config.apiUrl}/updateattendancenbraid`,
      method: 'POST',
      headers: customHeaders,
      data: formData,
      contentType: false,
  ...
  const baseUrl = `${config.apiUrl}`; // Replace with your base URL
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              ...
              <CardBody>
              Update Employee Attendance For OTA
              <hr class="mb-2"></hr>
...
export default NonBraidUpdateAttendanceImport;
