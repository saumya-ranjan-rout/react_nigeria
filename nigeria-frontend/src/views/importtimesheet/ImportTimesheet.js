...
import templateFile from '../../download/Worker_timesheet_template.csv'; // Import the template file
...
const templateFileName = 'Worker_timesheet_template.csv'; // Provide the actual file name
  ...
  const customHeaders = {
     ...
     const templateURL = `${config.appUrl}/importfiles/Employee-Master.csv`;
  ...
  $.ajax({
       url: `${config.apiUrl}/uploadtimesheet`,
      method: 'POST',
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              ...
              <CardBody>
              Import Worker Timesheet
              <hr class="mb-2"></hr>
              <label className="col-sm-12 col-form-label" for="name"> Your worker timesheet data file should as per this template <a href={templateFile} style={{ color: '#138656', fontWeight: 'bold' }} download={templateFileName}>
                    Download Template
                </a></label>
          <hr></hr>
