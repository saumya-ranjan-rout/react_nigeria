...
useEffect(() => {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: `${config.apiUrl}/additemcategory`,
      method: 'POST',
      ...
      success: function (response) {
        ...
        setServerMessageClass(response.message === 'Item Category already exists' ? 'alert alert-warning' : 'alert alert-success');
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              <CardHeader>
                <CardTitle tag="h5">Add New Item Category</CardTitle>
                <hr></hr>
              </CardHeader>
              <CardBody>
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-sm-6">
                        <input
                          ...
                          name="category_name"
                          value={formData.category_name}  onChange={handleInputChange} required
                        />
