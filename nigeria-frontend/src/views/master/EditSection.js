      ...
      if (id) {
        ...
        fetch(`${config.apiUrl}/getsection/${id}`,{headers: customHeaders})
         .then(response => response.json())
          .then(response => {
            const { section_name, target_unit } = response;
            setFormData({ section_name, target_unit });
          })
          .catch(error => {
            console.log(error);
          });
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              <CardHeader>
                <CardTitle tag="h5">Edit Section</CardTitle>
                 <hr></hr>
              </CardHeader>
              <CardBody>
              ...
              <label class="col-sm-2 col-form-label"
                           for="target_unit"><span className='textblack'>{t('Target Unit')}</span></label>
                    ...
                    <select
                      ...
                      >
         <option value="">{t('Select')} {t('Target Unit')}</option>
