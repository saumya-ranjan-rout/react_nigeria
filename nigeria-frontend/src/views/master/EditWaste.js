...
console.log(id);
  ...
  useEffect(() => {
    ...
    if (!isLoggedIn) {
      ...
      if (id) {
        console.log('ID:', id);
        fetch(`${config.apiUrl}/editwaste/${id}`,{headers: customHeaders})
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              <CardHeader>
                <CardTitle tag="h5">Edit Waste master</CardTitle>
                <hr></hr>
              </CardHeader>
              <CardBody>
                    ...
                    <div className="form-group row">
                      ...
                      <div className="col-sm-6">
                        <input
                          ...
                          name="waste_name"
                          value={formData.waste_name}  onChange={handleInputChange} required
                        />
