  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        setServerMessageClass(response.message === 'Shift already exists' ? 'alert alert-warning' : 'alert alert-success');
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              <CardHeader>
                <CardTitle tag="h5">Add New Shift</CardTitle>
                <hr></hr>
              </CardHeader>
              <CardBody>
               <form onSubmit={handleSubmit} method='POST' >
                  <div>
                    <div className="form-group row">
                      ...
                      <input type="number" placeholder={t('Name')}
                            className="form-control margin-bottom  required" name="shift_name"  value={formData.shift_name} onChange={handleInputChange} required/>
