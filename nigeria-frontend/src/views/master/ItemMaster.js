...
const [isActive, setActive] = useState(false);
  ...
  const handleView = (id, item_description,kg,string,pcs) => {
   navigate(`/admin/master/viewitem/${id}`, { state: { itemId: id, item_description: item_description, kg: kg, string: string, pcs: pcs } });
  };
            ...
            },
            {
              ...
              render: function (data, type, row, meta) {
                ...
                return `
                  ...
                  <button class="btn btn-sm btn-info" onclick="handleView(${id}, '${row.item_description}', '${row.kg}', '${row.string}', '${row.pcs}')" title="Add Section target"><i class="fa fa-eye" aria-hidden="true"></i> </button>
