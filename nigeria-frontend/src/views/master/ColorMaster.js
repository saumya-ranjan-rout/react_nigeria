...
const [isActive, setActive] = useState(false);
  ...
  const handleEdit = (id) => {
    navigate(`/admin/master/editcolor/${id}`);
  };
  ...
  const handleDelete = (id) => {
    ...
    if (tableRef.current) {
      ...
      fetch(`${config.apiUrl}/colordelete/${id}`, {
        method: 'DELETE',
        ...
        <Row>
          ...
          <Col md="12">
            <Card className="card-user">
              <CardHeader>
                <CardTitle tag="h5">Color Master <Link to="/admin/master/addnewcolor" className="btn btn-primary mr-2" style={{ margin: '0', padding: '5px', fontSize: '12px' }}>
              Add new
            </Link></CardTitle>
              </CardHeader>
              <CardBody>
